...
var SecondaryButton = /** @class */ (function(_super) {
      ...
      return react_1.default.createElement(
        ...
        _this.props.icon &&
          react_1.default.createElement(react_native_1.Image, {
            source: _this.props.icon,
            style: [styles.icon, _this.props.iconStyle],
          }),
        react_1.default.createElement(
          react_native_1.Text,
          { style: styles.text },
          _this.props.title.toUpperCase()
        )
      )
    }
    _this.renderLoadingState = function() {
      var styles = stylesFromProps(_this.props)
      return react_1.default.createElement(react_native_1.ActivityIndicator, {
  ...
  SecondaryButton.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ...
      { onPress: this.onPress.bind(this), style: [styles.wrapper, this.props.style] },
      this.props.displayState !== ButtonProps_1.ButtonDisplayState.Loading &&
...
var stylesFromProps = function(props) {
  return react_native_1.StyleSheet.create({
    wrapper: {
      ...
      borderRadius: props.buttonHeight
        ? props.buttonHeight / 2.0
        : ButtonProps_1.ButtonHeight.Regular / 2.0,
      paddingHorizontal: 8,
