...
var TimelineItem = /** @class */ (function(_super) {
  ...
  TimelineItem.prototype.render = function() {
    ...
    return react_1.default.createElement(
      ...
      react_1.default.createElement(TimelineProgress_1.TimelineProgress, {
        style: styles.progressLine,
        topPartVisible: isFirst !== true,
        bottomPartVisible: isLast !== true,
        topPartStyle:
          !isCompleted && !isActive
            ? TimelineProgress_1.LineStyle.Empty
            : TimelineProgress_1.LineStyle.Filled,
        markerStyle:
          !isCompleted && !isActive
            ? TimelineProgress_1.LineStyle.Empty
            : TimelineProgress_1.LineStyle.Filled,
        bottomPartStyle: isCompleted
          ? TimelineProgress_1.LineStyle.Filled
          : TimelineProgress_1.LineStyle.Empty,
      }),
        ...
        react_1.default.createElement(
          ...
          this.props.isCompleted &&
            react_1.default.createElement(react_native_1.Image, {
              source: res_1.Images.SmallCheck,
